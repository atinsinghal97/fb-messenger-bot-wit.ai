...
/**
// Generating the FB_VERIFY_TOKEN using the crypto function locally
...
app.get('/webhook', (req, res) => {
  if (req.query['hub.mode'] === 'subscribe' &&
    ...
    // use process.env.FB_VERIFY_TOKEN if not generating cryptographically
    // use FB_VERIFY_TOKEN if generating the token locally using the cryptographic function
